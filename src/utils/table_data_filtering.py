...
def filter_tables(directory_path):
        ...
        if filename.endswith(".csv"):
            ...
            try:
                ...
                filtered_df = filtered_df[
                    ~filtered_df.apply(lambda row: row.astype(str).str.contains(regex_exclude, regex=True).any(), axis=1)]
    ...
    if scope_data:
        ...
        date_columns = [col for col in combined_scope_data.columns if re.search(regex_date, col)]
